...
@drinker_router.get("/")
async def get_drinker_controllers_endpoint(user: User = Depends(current_superuser)):
...
async def get_drinker_state_endpoint(controller_id: int, user: User = Depends(current_superuser)):
    [
        drinker_input_angle,
...
async def drinker_params_endpoint(controller_id: int, user: User = Depends(current_superuser)):
    [
        drinker_input_angle,
        drinker_output_angle,
        drinker_water_level_current,
...
async def drinker_output_get_open_close_angles_endpoint(controller_id: int, user: User = Depends(current_superuser)):
...
async def drinker_input_get_open_close_angles_endpoint(controller_id: int, user: User = Depends(current_superuser)):
    [
        drinker_input_open_angle,
        drinker_input_close_angle
    ] = controller_api.drinker_input_get_servo_open_close_angles(
...
async def drinker_input_set_open_close_angles_endpoint(controller_id: int, open_angle: int, close_angle: int, user: User = Depends(current_superuser)):
    try:
...
async def drinker_output_set_open_close_angles_endpoint(controller_id: int, open_angle: int, close_angle: int, user: User = Depends(current_superuser)):
    try:
...
async def get_drinker_water_level_get_params_endpoint(controller_id: int, user: User = Depends(current_superuser)):
    try:
        [
            water_level_measure_iterations,
            water_level_max_cm_distance,
...
async def drinker_water_level_set_params_endpoint(controller_id: int, measure_iterations: int, max_cm_distance: int, max_level: int, min_level: int, user: User = Depends(current_superuser)):
    try:
...
async def drinker_water_level_moving_average_endpoint(controller_id: int, user: User = Depends(current_superuser)):
    try:
...
async def drinker_input_open_endpoint(controller_id: int, user: User = Depends(current_superuser)):
    try:
...
async def drinker_input_close_endpoint(controller_id: int, user: User = Depends(current_superuser)):
    try:
...
async def drinker_input_set_angle_endpoint(controller_id: int, angle: int, user: User = Depends(current_superuser)):
    try:
...
async def drinker_output_open_endpoint(controller_id: int, user: User = Depends(current_superuser)):
    try:
...
async def drinker_output_close_endpoint(controller_id: int, user: User = Depends(current_superuser)):
    try:
...
async def drinker_output_set_angle_endpoint(controller_id: int, angle: int, user: User = Depends(current_superuser)):
    try:
...
async def drinker_fill_endpoint(controller_id: int, user: User = Depends(current_superuser)):
    try:
...
async def drinker_empty_endpoint(controller_id: int, user: User = Depends(current_superuser)):
    try:
...
async def drinker_drinker_reset_endpoint(controller_id: int, user: User = Depends(current_superuser)):
    try:
